...
define_settings_group!(TabSettings, settings: [
    ...
    vertical_tabs_show_color_filter: VerticalTabsShowColorFilter {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        private: false,
        toml_path: "appearance.vertical_tabs.show_color_filter",
        description: "Whether to show the color filter bar at the bottom of the vertical tabs panel.",
    },
